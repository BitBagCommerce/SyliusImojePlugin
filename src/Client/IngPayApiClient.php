...
use BitBag\SyliusIngPayPlugin\Model\PaymentMethod\ServiceModel;
...
final class IngPayApiClient implements IngPayApiClientInterface
{
    ...
    public function createTransaction(
        ...
        try {
            ...
            throw new IngPayBadRequestException($e->getMessage());
        }
