...
final class ProcessStatusUrlGenerator implements StatusBasedUrlGeneratorInterface
{
    ...
    public function generate(Request $request, OrderInterface $order): string
    {
        ...
        $session
            ->getFlashBag()
            ->add('error', $this->translator->trans('bitbag_sylius_ing_plugin.ui.payment_process'));
